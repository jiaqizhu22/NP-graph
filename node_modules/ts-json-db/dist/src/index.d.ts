 ...
 */
declare type EntryType = "single" | "array" | "dictionary";
/**
 * Get the key of an object as a string.
 */
declare type GetKey<T> = Extract<keyof T, string>;
/**
 ...
 */
export declare type ContentBase = {
    [root in "paths"]: {
        [path: string]: {
            entryType: EntryType;
            valueType: any;
...
declare type PathsOfType<T, U extends EntryType> = {
 ...
 */
export declare class TypedJsonDB<ContentDef extends ContentBase> {
    /**
     ...
     * @memberof TypedJsonDB
     */
    constructor(filename: string, throwIfNotFound?: boolean, saveOnPush?: boolean, humanReadable?: boolean, separator?: string);
    /**
    ...
    */
    ...
    helpMeRemember: {
        singles: {
             ...
             */
            hintPlease<Path extends { [Key in keyof ContentDef["paths"]]: ContentDef["paths"][Key] extends {
                entryType: "single";
            } ? Key : never; }[Extract<keyof ContentDef["paths"], string>]>(_autocomplete: Path): void;
        };
        arrays: {
            /**
             * Don't call this method. It's only purpose is for the developer to get an autocomplete list of paths to arrays.
             */
            hintPlease<Path_1 extends { [Key_1 in keyof ContentDef["paths"]]: ContentDef["paths"][Key_1] extends {
                entryType: "array";
            } ? Key_1 : never; }[Extract<keyof ContentDef["paths"], string>]>(_autocomplete: Path_1): void;
        };
        dictionaries: {
            /**
             * Don't call this method. It's only purpose is for the developer to get an autocomplete list of paths to dictionaries.
             */
            hintPlease<Path_2 extends { [Key_2 in keyof ContentDef["paths"]]: ContentDef["paths"][Key_2] extends {
                entryType: "dictionary";
            } ? Key_2 : never; }[Extract<keyof ContentDef["paths"], string>]>(_autocomplete: Path_2): void;
        };
    };
}
export {};
